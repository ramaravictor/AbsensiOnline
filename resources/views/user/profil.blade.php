<html lang="en">
 ...
 <body class="bg-white font-sans">
  ...
  <main class="flex justify-center mt-10 px-4">
   <section class="w-full max-w-3xl rounded-lg shadow-md border border-gray-200 overflow-hidden">
    ...
    <div class="bg-[#0D8B2E] p-8 rounded-t-lg flex flex-col items-center">
     <img alt="Profile image of a man in brown uniform with hat and badge" class="w-28 h-28 rounded-full object-cover mb-4" height="112" src="https://storage.googleapis.com/a1aa/image/b2c63f9c-8af4-45aa-a60f-aa9ba1aba9ff.jpg" width="112"/>
     ...
     <p class="text-white text-[10px] font-normal leading-tight tracking-widest mt-1">
      19740616 199705 1 003
     </p>
     <p class="text-white text-[10px] font-normal leading-tight tracking-widest mt-2 text-center max-w-[300px]">
  ...
  <button aria-label="Red circular button with arrow icon" onclick="window.location.href='/'" class="fixed bottom-6 right-6 w-14 h-14 rounded-full border-2 border-red-600 flex items-center justify-center text-red-600 hover:bg-red-50" type="button">
